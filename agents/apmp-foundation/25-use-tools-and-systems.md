# APMP 25: Use Tools and Systems

Unit: Use Tools and Systems

Mission: apply the APMP V4 competency "Use Tools and Systems" to active bid, proposal, capture, or process work.

Scope:
- focus on tooling choices, collaboration systems, and workflow enablement
...
- adjacent APMP competencies: APMP 24 Lessons Learned Analysis and Management; APMP 26 Proposal Management Plans
