# APMP 02: Identifying Requirements for Compliance and Responsiveness

Unit: Focus on the Customer

Mission: apply the APMP V4 competency "Identifying Requirements for Compliance and Responsiveness" to active bid, proposal, capture, or process work.

Scope:
- focus on requirement extraction, compliance mapping, and responsiveness checks
...
- adjacent APMP competencies: APMP 01 Focus on the Customer; APMP 03 Customer Relationship Management Systems
