...
Mission: apply the APMP V4 competency "Headings" to active bid, proposal, capture, or process work.

Scope:
- focus on headline development, section guidance, and message-forward headings
...
- adjacent APMP competencies: APMP 19 Writing Clearly; APMP 21 Graphics
