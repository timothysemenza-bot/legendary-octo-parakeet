# APMP 31: Relevant Past Performance

Unit: Create Deliverables

Mission: apply the APMP V4 competency "Relevant Past Performance" to active bid, proposal, capture, or process work.

Scope:
- focus on past performance selection, relevance mapping, and proof formatting
...
- adjacent APMP competencies: APMP 30 Maintaining a Library and Writing Standard in Your Organization; APMP 32 Resumes
