...
Mission: apply the APMP V4 competency "Resumes" to active bid, proposal, capture, or process work.

Scope:
- focus on key-personnel resume tailoring and compliance alignment
...
- adjacent APMP competencies: APMP 31 Relevant Past Performance; APMP 33 Manage Processes
