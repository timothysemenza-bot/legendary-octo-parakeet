# APMP 13: Create Deliverables

Unit: Create Deliverables

Mission: apply the APMP V4 competency "Create Deliverables" to active bid, proposal, capture, or process work.

Scope:
- focus on deliverable planning, assembly ownership, and packaging readiness
...
- adjacent APMP competencies: APMP 12 Competitive Price to Win; APMP 14 Compliance Matrix
