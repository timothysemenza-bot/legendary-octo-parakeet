# APMP 22: Page and Document Design

Unit: Create Deliverables

Mission: apply the APMP V4 competency "Page and Document Design" to active bid, proposal, capture, or process work.

Scope:
- focus on document layout, page design, and readability standards
...
- adjacent APMP competencies: APMP 21 Graphics; APMP 23 Managing Internal Risk
