# APMP 23: Managing Internal Risk

Unit: Manage Processes

Mission: apply the APMP V4 competency "Managing Internal Risk" to active bid, proposal, capture, or process work.

Scope:
- focus on proposal execution risk logs, mitigations, and escalations
...
- adjacent APMP competencies: APMP 22 Page and Document Design; APMP 24 Lessons Learned Analysis and Management
