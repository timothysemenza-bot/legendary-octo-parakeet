# APMP 10: Features, Benefits, and Discriminators

Unit: Focus on the Customer

Mission: apply the APMP V4 competency "Features, Benefits, and Discriminators" to active bid, proposal, capture, or process work.

Scope:
- focus on feature-to-benefit translation and discriminator proofing
...
- adjacent APMP competencies: APMP 09 Proposal Theme Statements; APMP 11 Proof Points
