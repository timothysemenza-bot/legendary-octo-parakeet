# APMP 39: Production Management

Unit: Manage Processes

Mission: apply the APMP V4 competency "Production Management" to active bid, proposal, capture, or process work.

Scope:
- focus on production control, submission readiness, and final packaging
...
- adjacent APMP competencies: APMP 38 Review Management; APMP 40 Virtual Team Management
