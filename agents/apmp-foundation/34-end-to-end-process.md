# APMP 34: End-to-End Process

Unit: Manage Processes

Mission: apply the APMP V4 competency "End-to-End Process" to active bid, proposal, capture, or process work.

Scope:
- focus on lifecycle mapping from capture through submission and handoff
...
- adjacent APMP competencies: APMP 33 Manage Processes; APMP 35 Gate Decisions
