# APMP 05: Value Propositions

Unit: Focus on the Customer

Mission: apply the APMP V4 competency "Value Propositions" to active bid, proposal, capture, or process work.

Scope:
- focus on outcome framing, value articulation, and differentiating business benefits
...
- adjacent APMP competencies: APMP 04 Developing an Opportunity/Capture Management Strategy; APMP 06 Customer and Competitor Intelligence
