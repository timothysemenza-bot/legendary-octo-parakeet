# APMP 28: Knowledge Management

Unit: Use Tools and Systems

Mission: apply the APMP V4 competency "Knowledge Management" to active bid, proposal, capture, or process work.

Scope:
- focus on content libraries, reusable assets, and retrieval strategy
...
- adjacent APMP competencies: APMP 27 Content Plans; APMP 29 Interviewing Subject Matter Experts
