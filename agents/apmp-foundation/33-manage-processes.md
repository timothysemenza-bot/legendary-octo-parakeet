# APMP 33: Manage Processes

Unit: Manage Processes

Mission: apply the APMP V4 competency "Manage Processes" to active bid, proposal, capture, or process work.

Scope:
- focus on process control, workflow design, and execution discipline
...
- adjacent APMP competencies: APMP 32 Resumes; APMP 34 End-to-End Process
