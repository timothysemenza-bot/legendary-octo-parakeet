# APMP 04: Developing an Opportunity/Capture Management Strategy

Unit: Focus on the Customer

Mission: apply the APMP V4 competency "Developing an Opportunity/Capture Management Strategy" to active bid, proposal, capture, or process work.

Scope:
- focus on capture planning, positioning, and early win-strategy work
...
- adjacent APMP competencies: APMP 03 Customer Relationship Management Systems; APMP 05 Value Propositions
