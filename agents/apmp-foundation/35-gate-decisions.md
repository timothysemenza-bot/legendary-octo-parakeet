# APMP 35: Gate Decisions

Unit: Manage Processes

Mission: apply the APMP V4 competency "Gate Decisions" to active bid, proposal, capture, or process work.

Scope:
- focus on go-no-go reviews, pursuit qualification, and decision criteria
...
- adjacent APMP competencies: APMP 34 End-to-End Process; APMP 36 Kickoff Meeting Management
