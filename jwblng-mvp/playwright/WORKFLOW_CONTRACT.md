...
- Every flow must:
  ...
  - write screenshots to `jwblng-mvp/playwright/artifacts`.

## Flow: Join Page Draft
- Command: `npm run pw:jwblng:join`
- Required env:
  - `ALLOW_KAJABI_WRITES=1`
- Optional env:
  - `JWBLNG_JOIN_PAGE_TITLE` (default: `Join JWBLNG`)
  - `JWBLNG_JOIN_PAGE_PATH` (default: `/join`)
- Expected behavior:
  - open Website Pages,
  - start new page flow,
...
## One-Command Runner
- Script: `jwblng-mvp/playwright/scripts/run-flow.ps1`
