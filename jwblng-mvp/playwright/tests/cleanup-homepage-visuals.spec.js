...
async function rewriteHeroText(activePage, heading, subheading) {
  ...
  const styledHtml = `
    <section style="padding:34px;border-radius:18px;border:1px solid currentColor;">
      ...
      <p style="margin:0;">
        <a href="/join" style="display:inline-block;padding:11px 18px;border-radius:999px;border:1px solid currentColor;text-decoration:none;font-weight:700;">Join JWBLNG</a>
