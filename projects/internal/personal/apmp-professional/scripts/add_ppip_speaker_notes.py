...
PPT_PATH = PROJECT_ROOT / "deliverables" / "Timothy Semenza APMP Professional PPIP Draft.pptx"
TALK_TRACK_PATH = PROJECT_ROOT / "working" / "ppip-talk-track.md"
BACKUP_DIR = PROJECT_ROOT / "archive" / "deliverables" / "backups"
