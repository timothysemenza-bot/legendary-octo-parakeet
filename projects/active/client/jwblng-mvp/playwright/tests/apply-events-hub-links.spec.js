...
async function rewriteHubTextBlock(activePage) {
  ...
  const html = `
    <section style="padding:28px;border-radius:14px;border:1px solid currentColor;">
      ...
      <p style="margin:0;">
        <a href="${joinUrl}" style="display:inline-block;padding:10px 16px;border-radius:999px;border:1px solid currentColor;text-decoration:none;font-weight:600;">Join JWBLNG</a>
      </p>
    </section>
  `;
